...
INTERNAL size_t otrv4_serialize_data(uint8_t *target, const uint8_t *data, size_t len);
...
INTERNAL size_t otrv4_serialize_otrv4_public_key(uint8_t *dst, const otrv4_public_key_t);
