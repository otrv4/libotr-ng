...
static inline bool sha3_512(uint8_t *dst, size_t dst_len, const uint8_t *src,
                            size_t src_len) {
...
static inline bool sha3_256(uint8_t *dst, size_t dst_len, const uint8_t *src,
                            size_t src_len) {
...
static bool sha3_kkdf(int algo, uint8_t *dst, size_t dstlen, const uint8_t *key,
...
static inline bool sha3_512_mac(uint8_t *dst, size_t dstlen, const uint8_t *key,
                                size_t keylen, const uint8_t *msg,
                                size_t msglen) {
  return sha3_kkdf(GCRY_MD_SHA3_512, dst, dstlen, key, keylen, msg, msglen);
}

static inline bool sha3_256_kdf(uint8_t *key, size_t keylen,
                                const uint8_t magic[1], const uint8_t *secret,
                                size_t secretlen) {
  return sha3_kkdf(GCRY_MD_SHA3_256, key, keylen, magic, 1, secret, secretlen);
}

static inline bool sha3_512_kdf(uint8_t *key, size_t keylen,
                                const uint8_t magic[1], const uint8_t *secret,
                                size_t secretlen) {
