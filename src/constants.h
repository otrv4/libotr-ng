...
#define OTRNG_PROTOCOL_VERSION_NONE 0
...
#define IDENTITY_MAX_BYTES                                                     \
  (DAKE_HEADER_BYTES + (2 * ED448_POINT_BYTES) + (2 * DH_MPI_MAX_BYTES))
