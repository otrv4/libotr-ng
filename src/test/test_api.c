...
void test_api_multiple_clients(void) {
  ...
  assert_rec_msg_inc_state(result, pc_to_alice, bob_pc,
  ...
  assert_rec_msg_inc_state(result, alice_to_phone, alice,
                           OTRNG_STATE_WAITING_AUTH_I, send_response);
