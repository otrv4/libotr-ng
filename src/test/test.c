...
int main(int argc, char **argv)
{
	...
	g_test_add_func("/smp/generate_validate_msg_3",
			test_smp_validates_msg_3);
	g_test_add_func("/smp/generate_validate_msg_4",
			test_smp_validates_msg_4);
