...
static void test_ecdh_proof_generation_and_validation(void) {
  ...
  otrng_assert_is_success(otrng_ecdh_proof_generate(
      &res, (const ec_scalar_t *)privs, (const ec_point_t *)pubs, 3, m, 0x13));
  otrng_assert(
      otrng_ecdh_proof_verify(&res, (const ec_point_t *)pubs, 3, m, 0x13));
  otrng_assert(
      !otrng_ecdh_proof_verify(&res, (const ec_point_t *)pubs, 3, m, 0x14));
  otrng_assert(
      !otrng_ecdh_proof_verify(&res, (const ec_point_t *)pubs, 3, m2, 0x13));
