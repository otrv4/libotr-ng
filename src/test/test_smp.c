...
void test_smp_validates_msg_2(void) {
  ...
  otrv4_assert(smp_msg_2_asprintf(&buff, &bufflen, msg_2) == OTR4_SUCCESS);
  ...
  otrv4_assert(smp_msg_2_valid_zkp(msg_2, smp) == OTR4_SUCCESS);
  otrv4_assert(smp_msg_2_valid_zkp(smp_msg_2, smp) == OTR4_SUCCESS);
...
void test_smp_validates_msg_3(void) {
  ...
  otrv4_assert(smp_msg_3_asprintf(&buff, &bufflen, msg_3) == OTR4_SUCCESS);
...
void test_smp_validates_msg_4(void) {
  ...
  otrv4_assert(smp_msg_4_asprintf(&buff, &bufflen, msg_4) == OTR4_SUCCESS);
