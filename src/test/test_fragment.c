...
void test_create_fragments(void) {
  ...
  g_assert_cmpstr(frag_message->pieces[0], ==,
                  "?OTR|00000000|00000001|00000002,00001,00004,one,");
  g_assert_cmpstr(frag_message->pieces[1], ==,
                  "?OTR|00000000|00000001|00000002,00002,00004, tw,");
  g_assert_cmpstr(frag_message->pieces[2], ==,
                  "?OTR|00000000|00000001|00000002,00003,00004,o t,");
  g_assert_cmpstr(frag_message->pieces[3], ==,
                  "?OTR|00000000|00000001|00000002,00004,00004,ree,");
