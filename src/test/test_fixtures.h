...
void otrv4_fixture_set_up(otrv4_fixture_t * otrv4_fixture, gconstpointer data)
{
	...
	otrv4_fixture->otr = otrv4_new_with_lt_key(otrv4_keypair_new(),
            otrv4_fixture->keypair, policy);

	otrv4_policy_t policyv3 = {.allows = OTRV4_ALLOW_V3 };
	otrv4_fixture->otrv3 = otrv4_new_with_lt_key(otrv4_keypair_new(),
            otrv4_fixture->keypair, policyv3);

	otrv4_policy_t policyv34 = {.allows = OTRV4_ALLOW_V3 | OTRV4_ALLOW_V4 };
	otrv4_fixture->otrv34 = otrv4_new_with_lt_key(otrv4_keypair_new(),
            otrv4_fixture->keypair, policyv34);
}
