...
#define XYZ_OTRNG_PREKEY_CLIENT_PRIVATE
#define OTRNG_PREKEY_MANAGER_PRIVATE
#define OTRNG_PREKEY_MESSAGE_PRIVATE
#define OTRNG_PREKEY_PROFILE_PRIVATE
#define OTRNG_PROTOCOL_PRIVATE
#define OTRNG_SHAKE_PRIVATE
