...
void test_calculate_extra_symm_key() {
  ...
  shared_secret_p s = {};
  uint8_t expected_extra_key[HASH_BYTES] = {
      0xbb, 0x21, 0x75, 0x61, 0x3d, 0xf1, 0x99, 0x97, 0x51, 0x0e, 0xca,
      0x72, 0x5f, 0x60, 0x8f, 0x65, 0xe5, 0x7f, 0x3c, 0xc9, 0x20, 0x80,
      0xa5, 0x91, 0xf0, 0x7d, 0xfa, 0x21, 0xf6, 0x0b, 0x88, 0x7f, 0x78,
      0xea, 0x75, 0xc0, 0x27, 0x3f, 0xb7, 0xf2, 0xd6, 0xde, 0x54, 0xe0,
      0x7d, 0x94, 0xe0, 0x55, 0x95, 0x6f, 0x7a, 0x10, 0x81, 0x10, 0x0f,
      0xa6, 0xf9, 0x2e, 0x68, 0x07, 0x2f, 0xf0, 0xc4, 0x1f,
  };

  memcpy(s, manager->current->chain_s, sizeof(sending_chain_key_p));

  calculate_extra_key(manager, true);
  otrng_assert_cmpmem(expected_extra_key, manager->extra_key, HASH_BYTES);
