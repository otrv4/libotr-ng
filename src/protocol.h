...
#define OTRNG_REQUIRE_ENCRYPTION 0x04
#define OTRNG_SEND_WHITESPACE_TAG 0x05
#define OTRNG_WHITESPACE_START_AKE 0x06
#define OTRNG_ERROR_START_AKE 0x07
#define OTRNG_REQUIRE_INTERACTIVE 0x08
#define OTRNG_IDENTITY_START_DAKE 0x09
...
#define OTRNG_POLICY_OPPORTUNISTIC (OTRNG_WHITESPACE_START_AKE)
#define OTRNG_POLICY_ALWAYS (OTRNG_WHITESPACE_START_AKE)
